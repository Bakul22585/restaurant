                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="col-xs-12 col-md-6 text-right">
                            <a href="javascript:void(0)" class="btn btn-info btn-flat add-meal" title="Add Restaurant"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add</a>
                    ...
                    <div class="box-body table-responsive">
                        <table id="meal-table" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Name</th>
...
<div class="modal fade" id="modal-meal">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <form id="form-meal" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="meal_name">Meal Name (English-en)*</label>
                                <input type="text" class="form-control" name="meal_name" id="meal_name" placeholder="Enter Meal Name">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="meal_name_pt">Meal Name (Portuguese-pt)*</label>
                                <input type="text" class="form-control" name="meal_name_pt" id="meal_name_pt" placeholder="Enter Meal Name">
                            </div>
                        </div>
                    </div>
                </div>
