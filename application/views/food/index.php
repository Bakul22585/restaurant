                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="col-xs-12 col-md-6 text-right">
                            <a href="javascript:void(0)" class="btn btn-info btn-flat add-food" title="Add Restaurant"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add</a>
                    ...
                    <div class="box-body table-responsive">
                        <table id="food-table" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Name</th>
            ...
            <form id="form-food" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="food_name">Food Name (English-en)*</label>
                                <input type="text" class="form-control" name="food_name" id="food_name" placeholder="Enter Food Name">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="food_name_pt">Food Name (Portuguese-pt)*</label>
                                <input type="text" class="form-control" name="food_name_pt" id="food_name_pt" placeholder="Enter Food Name">
                            </div>
                        </div>
                    </div>
                </div>
