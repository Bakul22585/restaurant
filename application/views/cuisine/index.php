            ...
            <div class="col-xs-12 col-md-12">
                <div class="box">
                    <div class="box-header">
                        <div class="col-xs-12 col-md-3" style="padding-left: 0;">
                            <!-- <div class="form-group">
                                <select class="form-control" name="filter_cuisine" id="filter_cuisine">
                                    <?php if (!empty($city)) { ?>
                        ...
                        <div class="col-xs-12 col-md-6 text-right">
                            <a href="javascript:void(0)" class="btn btn-info btn-flat add-cuisine" title="Add Restaurant"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add</a>
                    ...
                    <div class="box-body table-responsive">
                        <table id="cuisine-table" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Name</th>
...
<div class="modal fade" id="modal-cuisine">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <form id="form-cuisine" enctype="multipart/form-data">
                <input type="hidden" name="form-action" id="form-action">
                <input type="hidden" name="res_cuisine_id" id="cuisine_id">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="res_cuisine_name">Cuisine Name (English-en)*</label>
                                <input type="text" class="form-control" name="res_cuisine_name" id="cuisine_name" placeholder="Enter Cuisine Name">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="res_cuisine_name_pt">Cuisine Name (Portuguese-pt)*</label>
                                <input type="text" class="form-control" name="res_cuisine_name_pt" id="cuisine_name_pt" placeholder="Enter Cuisine Name">
                            </div>
                        </div>
                    </div>
                </div>
