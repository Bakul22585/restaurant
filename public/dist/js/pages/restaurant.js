jQuery(document).ready(function(){
    ...
    jQuery(document).on('click','.add-restaurant',function(){
        ...
        jQuery('#modal-restaurant .Image-contain').html('');
    ...
    jQuery("#form-restaurant").validate({
        ...
        messages: {
            ...
            'restaurant_mobile': {
                required: "Please Enter Restaurant Mobile No"
            },
            'restaurant_description': {
        ...
        errorPlacement: function(error, element){
            if(element.attr("name") == "allow[]"){
              ...
              if (error.parent().find('.input-group-addon').attr('class') != undefined) {
                error.parent().find('.input-group-addon').addClass('timepicker-box');
                error.parent().find('.TimeTag').addClass('timepicker-box-input-width');
            }
        }
    });
    jQuery(document).on('submit','#form-restaurant',function(e){
        jQuery('#modal-restaurant').addClass('loader');
        jQuery('#modal-restaurant .loader-icon').css('display', 'unset');
        e.preventDefault();
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                jQuery('#modal-restaurant').removeClass('loader');
                jQuery('#modal-restaurant .loader-icon').css('display', 'none');
                if(data.flag){
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                if(data.flag){
                    ...
                    jQuery('#modal-restaurant #form-restaurant #restaurant_mobile').val(data.data.res_mob);
