<style>
    ...
    .Image-contain a.btn.btn-danger.btn-flat.btn-xs.delete-restaurant-main-image {
        height: 25px;
        width: 25px;
    }
    ...
    .time-table {
        display: grid;
        grid-template-columns: 68px 250px 250px;
        grid-gap: 15px;
        margin-bottom: 10px;
    }
...
<div class="modal fade" id="modal-restaurant">
    <i class="fa fa-refresh fa-spin loader-icon" style="position: absolute;top: 265%;left: 42%;font-size: 191px;z-index: 2;"></i>
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="form-restaurant" enctype="multipart/form-data">
                ...
                <input type="hidden" name="userTimeZone" id="userTimeZone">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="restaurant_name">Restaurant Mobile *</label>
                                <input type="text" class="form-control" name="restaurant_mobile" id="restaurant_mobile" placeholder="Enter Mobile">
                            </div>

                            <div class="form-group">
                                <label for="restaurant_description">Restaurant Description *</label>
                                <textarea class="form-control" rows="3" name="restaurant_description" id="restaurant_description" placeholder="Enter Description" style="width: 100%;"></textarea>
                            </div>
                            <!-- <div class="form-group">
                            ...
                            <div class="DisplayMainImage hide">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="3" name="restaurant_address" id="restaurant_address" placeholder="Enter Address" style="width: 100%;"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="latitude">Latitude *</label>
                                <input type="text" class="form-control" name="latitude" id="latitude" placeholder="Enter Latitude">
                            ...
                            <div class="form-group" style="display: grid;grid-template-columns: auto auto;"> <label for="day_open">Halal *</label>
                                <label></label>
                                <div class="radio" style="margin-top: -5px;">
                                    <label><input type="radio" name="halal" value="0" id="serves_alcohol">Yes(With Certificate)</label>
                                </div>
                                <div class="radio" style="margin-top: -5px;">
                                    <label><input type="radio" name="halal" value="1" id="serves_alcohol">Yes(Without Certificate)</label>
                                </div>
                                <div class="radio" style="margin-top: -5px;">
                                    <label><input type="radio" name="halal" value="2" id="serves_alcohol">No</label>
                                </div>
                                <div id="halal_error"></div>
                            </div>
                            <div class="form-group" style="display: grid;grid-template-columns: auto auto;">
